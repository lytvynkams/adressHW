...
class Address(Field):
    ...
    def validate(self):
        ...
        if not self.is_ukrainian(self.street):
            raise ValueError("Адреса має бути українською мовою (без латиниці або спецсимволів).")

    def is_ukrainian(self, text):
        # Дозволені: українські літери, пробіли, цифри, кома, крапка
        pattern = r"^[А-ЩЬЮЯЄІЇҐа-щьюяєіїґ0-9\s\.\-']+$"
